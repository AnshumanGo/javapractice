...
public class _1MethodOverloadingStaticPolymorphism {
    ...
    static void print(int a,int b){System.out.println("int arg method invoked");}
    static void print(long a,long b){System.out.println("long arg method invoked");}

    //Method Overloading with Type Promotion in case of ambiguity
    static void test(int a,long b){System.out.println("a method invoked");}
    static void test(long a,int b){System.out.println("b method invoked");}
